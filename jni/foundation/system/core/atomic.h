...
#ifndef LIYL_CUTILS_ATOMIC_H
#define LIYL_CUTILS_ATOMIC_H
...
#define LIYL_ATOMIC_INLINE static inline
#endif
 ...
 */
LIYL_ATOMIC_INLINE
int32_t liyl_atomic_inc(volatile int32_t* addr)
{
...
LIYL_ATOMIC_INLINE
int32_t liyl_atomic_dec(volatile int32_t* addr)
{
    volatile atomic_int_least32_t* a = (volatile atomic_int_least32_t*)addr;
...
LIYL_ATOMIC_INLINE
int32_t liyl_atomic_add(int32_t value, volatile int32_t* addr)
{
    volatile atomic_int_least32_t* a = (volatile atomic_int_least32_t*)addr;
...
LIYL_ATOMIC_INLINE
int32_t liyl_atomic_and(int32_t value, volatile int32_t* addr)
{
    volatile atomic_int_least32_t* a = (volatile atomic_int_least32_t*)addr;
...
LIYL_ATOMIC_INLINE
int32_t liyl_atomic_or(int32_t value, volatile int32_t* addr)
{
    volatile atomic_int_least32_t* a = (volatile atomic_int_least32_t*)addr;
 ...
 */
LIYL_ATOMIC_INLINE
int32_t liyl_atomic_acquire_load(volatile const int32_t* addr)
{
    volatile atomic_int_least32_t* a = (volatile atomic_int_least32_t*)addr;
...
LIYL_ATOMIC_INLINE
int32_t liyl_atomic_release_load(volatile const int32_t* addr)
{
    volatile atomic_int_least32_t* a = (volatile atomic_int_least32_t*)addr;
 ...
 */
LIYL_ATOMIC_INLINE
void liyl_atomic_acquire_store(int32_t value, volatile int32_t* addr)
{
    volatile atomic_int_least32_t* a = (volatile atomic_int_least32_t*)addr;
...
LIYL_ATOMIC_INLINE
void liyl_atomic_release_store(int32_t value, volatile int32_t* addr)
{
    volatile atomic_int_least32_t* a = (volatile atomic_int_least32_t*)addr;
 ...
 */
LIYL_ATOMIC_INLINE
int liyl_atomic_acquire_cas(int32_t oldvalue, int32_t newvalue,
...
LIYL_ATOMIC_INLINE
int liyl_atomic_release_cas(int32_t oldvalue, int32_t newvalue,
                               volatile int32_t* addr)
{
    volatile atomic_int_least32_t* a = (volatile atomic_int_least32_t*)addr;
    return (int)(!atomic_compare_exchange_strong_explicit(
 ...
 */
LIYL_ATOMIC_INLINE
void liyl_compiler_barrier(void)
{
 ...
 * in a future release.
 */
#define liyl_atomic_write liyl_atomic_release_store
#define liyl_atomic_cmpxchg liyl_atomic_release_cas

#endif // LIYL_CUTILS_ATOMIC_H
