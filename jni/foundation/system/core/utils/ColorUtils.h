...
#ifndef LIYL_COLOR_UTILS_H_

#define LIYL_COLOR_UTILS_H_

#include <stdint.h>

#define STRINGIFY_ENUMS

#include "../../../media/include/AMessage.h"

#include "../../../../common/include/VideoAPI.h"
...
#undef GET_HAL_ENUM
    ...
    static liyl_dataspace getDataSpaceForColorAspects(ColorAspects &aspects, bool mayExpand);

    // converts |dataSpace| to a V0 enum, and returns true if dataSpace is an aspect-only value
    static bool convertDataSpaceToV0(liyl_dataspace &dataSpace);
...
inline static const char *asString(liyl::ColorUtils::ColorStandard i, const char *def = "??") {
    using namespace liyl;
    switch (i) {
...
inline static const char *asString(liyl::ColorUtils::ColorTransfer i, const char *def = "??") {
    using namespace liyl;
    switch (i) {
...
inline static const char *asString(liyl::ColorUtils::ColorRange i, const char *def = "??") {
    using namespace liyl;
    switch (i) {
