...
#ifndef __LIYL_A_DEBUG_H_

#define __LIYL_A_DEBUG_H_
...
#define ENTER_FUNC do{ LLOGV("enter %s  %d",__func__,__LINE__);}while(0)
#define ESC_FUNC do{ LLOGV("esc  %s  %d",__func__,__LINE__);}while(0)

LIYL_NAMESPACE_END

#endif  // __LIYL_A_DEBUG_H_
