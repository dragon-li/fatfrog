...
#include "../system/core/utils/Flattenable.h"
#include "../system/core/utils/Timers.h"
#include "../system/core/utils/RefBase.h"
#include "../media/include/AString.h"
...
public:
    ...
    static sp<Fence> merge(const AString& name, const sp<Fence>& f1,
            const sp<Fence>& f2);
