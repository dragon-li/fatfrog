/*
 * Copyright 2014 The Liyl Open Source Project
 *
...
inline static const char *asString(OMX_AUDIO_CODINGEXTTYPE i, const char *def = "??") {
    switch (i) {
        case OMX_AUDIO_CodingLiylAC3:  return "LiylAC3";
        case OMX_AUDIO_CodingLiylOPUS: return "LiylOPUS";
...
//      case OMX_IndexConfigCommit:                     return "ConfigCommit";
        case OMX_IndexParamAudioLiylAc3:             return "ParamAudioLiylAc3";
        case OMX_IndexParamAudioLiylOpus:            return "ParamAudioLiylOpus";
        case OMX_IndexParamAudioLiylAacPresentation: return "ParamAudioLiylAacPresentation";
...
//      case OMX_IndexConfigVideoVp8ReferenceFrameType: return "ConfigVideoVp8ReferenceFrameType";
        case OMX_IndexParamVideoLiylVp8Encoder:      return "ParamVideoLiylVp8Encoder";
        case OMX_IndexParamVideoHevc:                   return "ParamVideoHevc";
//      case OMX_IndexParamSliceSegments:               return "ParamSliceSegments";
        case OMX_IndexConfigLiylIntraRefresh:        return "ConfigLiylIntraRefresh";
        case OMX_IndexParamLiylVideoTemporalLayering: return "ParamLiylVideoTemporalLayering";
        case OMX_IndexConfigLiylVideoTemporalLayering: return "ConfigLiylVideoTemporalLayering";
...
inline static const char *asString(OMX_COLOR_FORMATTYPE i, const char *def = "??") {
    switch (i) {
        ...
        case OMX_COLOR_FormatLiylOpaque:
            return "COLOR_FormatLiylOpaque";
...
inline static const char *asString(
        OMX_VIDEO_LIYL_VPXTEMPORALLAYERPATTERNTYPE i, const char *def = "??") {
    switch (i) {
...
inline static const char *asString(
        OMX_VIDEO_LIYL_TEMPORALLAYERINGPATTERNTYPE i, const char *def = "??") {
    switch (i) {
        case OMX_VIDEO_LiylTemporalLayeringPatternNone:    return "None";
        case OMX_VIDEO_LiylTemporalLayeringPatternWebRTC:  return "WebRTC";
        case OMX_VIDEO_LiylTemporalLayeringPatternLiyl: return "Liyl";
        default:                                              return def;
    }
}
