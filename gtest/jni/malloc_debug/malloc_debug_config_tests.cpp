...
TEST_F(MallocDebugConfigTest, unknown_option) {
  ...
  std::string log_msg("6 malloc_debug omx_test: unknown option unknown_option\n");
...
TEST_F(MallocDebugConfigTest, unparseable_number) {
  ...
  ASSERT_STREQ("", getFakeLogBuf().c_str());
  std::string log_msg("6 malloc_debug omx_test: bad value for option 'backtrace'\n");
  ASSERT_STREQ((log_msg + usage_string).c_str(), getFakeLogPrint().c_str());
}
...
TEST_F(MallocDebugConfigTest, illegal_value_zero) {
  ...
  ASSERT_STREQ("", getFakeLogBuf().c_str());
  std::string log_msg(
      "6 malloc_debug omx_test: bad value for option 'backtrace', value must be >= 1: 0\n");
  ASSERT_STREQ((log_msg + usage_string).c_str(), getFakeLogPrint().c_str());
}
...
TEST_F(MallocDebugConfigTest, no_space) {
  ...
  ASSERT_STREQ("", getFakeLogBuf().c_str());
  std::string log_msg(
      "6 malloc_debug omx_test: bad value for option 'backtrace', "
...
TEST_F(MallocDebugConfigTest, set_value_error) {
  ...
  ASSERT_STREQ("", getFakeLogBuf().c_str());
  std::string log_msg(
      "6 malloc_debug omx_test: value set for option 'leak_track' "
...
TEST_F(MallocDebugConfigTest, guard_min_error) {
  ...
  ASSERT_STREQ("", getFakeLogBuf().c_str());
  std::string log_msg(
      "6 malloc_debug omx_test: bad value for option 'guard', value must be >= 1: 0\n");
  ASSERT_STREQ((log_msg + usage_string).c_str(), getFakeLogPrint().c_str());
}
...
TEST_F(MallocDebugConfigTest, guard_max_error) {
  ...
  ASSERT_STREQ("", getFakeLogBuf().c_str());
  std::string log_msg(
      "6 malloc_debug omx_test: bad value for option 'guard', "
...
TEST_F(MallocDebugConfigTest, front_guard_min_error) {
  ...
  ASSERT_STREQ("", getFakeLogBuf().c_str());
  std::string log_msg(
      "6 malloc_debug omx_test: bad value for option 'front_guard', "
      "value must be >= 1: 0\n");
  ASSERT_STREQ((log_msg + usage_string).c_str(), getFakeLogPrint().c_str());
}
...
TEST_F(MallocDebugConfigTest, rear_guard_min_error) {
  ...
  ASSERT_STREQ("", getFakeLogBuf().c_str());
  std::string log_msg(
      "6 malloc_debug omx_test: bad value for option 'rear_guard', "
      "value must be >= 1: 0\n");
  ASSERT_STREQ((log_msg + usage_string).c_str(), getFakeLogPrint().c_str());
}
...
TEST_F(MallocDebugConfigTest, fill_min_error) {
  ...
  ASSERT_STREQ("", getFakeLogBuf().c_str());
  std::string log_msg(
      "6 malloc_debug omx_test: bad value for option 'fill', "
      "value must be >= 1: 0\n");
  ASSERT_STREQ((log_msg + usage_string).c_str(), getFakeLogPrint().c_str());
}
...
TEST_F(MallocDebugConfigTest, fill_on_alloc_min_error) {
  ...
  ASSERT_STREQ("", getFakeLogBuf().c_str());
  std::string log_msg(
      "6 malloc_debug omx_test: bad value for option 'fill_on_alloc', "
      "value must be >= 1: 0\n");
  ASSERT_STREQ((log_msg + usage_string).c_str(), getFakeLogPrint().c_str());
}
...
TEST_F(MallocDebugConfigTest, fill_on_free_min_error) {
  ...
  ASSERT_STREQ("", getFakeLogBuf().c_str());
  std::string log_msg(
      "6 malloc_debug omx_test: bad value for option 'fill_on_free', "
      "value must be >= 1: 0\n");
  ASSERT_STREQ((log_msg + usage_string).c_str(), getFakeLogPrint().c_str());
}
...
TEST_F(MallocDebugConfigTest, backtrace_enable_on_signal_min_error) {
  ...
  ASSERT_STREQ("", getFakeLogBuf().c_str());
  std::string log_msg(
      "6 malloc_debug omx_test: bad value for option 'backtrace_enable_on_signal', "
      "value must be >= 1: 0\n");
  ASSERT_STREQ((log_msg + usage_string).c_str(), getFakeLogPrint().c_str());
}
...
TEST_F(MallocDebugConfigTest, expand_alloc_min_error) {
  ...
  ASSERT_STREQ("", getFakeLogBuf().c_str());
  std::string log_msg(
      "6 malloc_debug omx_test: bad value for option 'expand_alloc', "
      "value must be >= 1: 0\n");
  ASSERT_STREQ((log_msg + usage_string).c_str(), getFakeLogPrint().c_str());
}
...
TEST_F(MallocDebugConfigTest, free_track_min_error) {
  ...
  ASSERT_STREQ("", getFakeLogBuf().c_str());
  std::string log_msg(
      "6 malloc_debug omx_test: bad value for option 'free_track', "
      "value must be >= 1: 0\n");
  ASSERT_STREQ((log_msg + usage_string).c_str(), getFakeLogPrint().c_str());
}
...
TEST_F(MallocDebugConfigTest, free_track_backtrace_num_frames_max_error) {
  ...
  ASSERT_STREQ("", getFakeLogBuf().c_str());
  std::string log_msg(
      "6 malloc_debug omx_test: bad value for option 'free_track_backtrace_num_frames', "
