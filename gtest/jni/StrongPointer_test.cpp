 ...
 */
#define LOG_NDEBUG 0
#define LOG_TAG "UT_StrongPointer"
#include <gtest/gtest.h>
#include "../../jni/foundation/system/core/utils/Log.h"
#include "../../jni/foundation/system/core/utils/StrongPointer.h"
#include "../../jni/foundation/system/core/utils/RefBase.h"
...
class UT_StrongPointer: public ::testing::Test {

    public:
        virtual void SetUp(){
            LLOGD("liyl add SetUp");
        }
        virtual void TearDown(){
            LLOGD("liyl add TearDown");
        }
...
TEST_F(UT_StrongPointer, test_0) {
    LLOGD("liyl add test [move]");
    bool isDeleted;
